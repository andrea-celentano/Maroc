...
#define CH_DEFAULT	1024	// electronic channel
#define CH2_DEFAULT	1025	// electronic channel
#define CHNNLFIRST	0
...
#define MRC_VERBOSE 2 // 0= information, 1= +error, 2= +warning, 3= +message, 4= +debug message, 5= +dump 
