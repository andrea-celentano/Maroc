...
private:
	...
	Int_t		fSingleHITEntries[MAX_PIXEL];	
	Float_t		fSingleHITMean[MAX_PIXEL];	
	Float_t		fSingleHITRms[MAX_PIXEL];	
	Float_t		fSingleHITMax[MAX_PIXEL];
	Float_t		fSingleHITMin[MAX_PIXEL];		
